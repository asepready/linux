...
$CONF['admin_email'] = 'admin@asepready.id';
...
$CONF['default_aliases'] = array (
    'abuse' => 'abuse@asepready.id',
    'hostmaster' => 'hostmaster@asepready.id',
    'postmaster' => 'postmaster@asepready.id',
    'webmaster' => 'webmaster@asepready.id'
);
...
$CONF['vacation_domain'] = 'autoreply.asepready.id';
...
$CONF['user_footer_link'] = "http://asepready.id/postfixadmin";

// Footer
// Below information will be on all pages.
// If you don't want the footer information to appear set this to 'NO'.
$CONF['show_footer_text'] = 'YES';
$CONF['footer_text'] = 'Return to asepready.id';
$CONF['footer_link'] = 'http://asepready.id/postfixadmin/main.php';
